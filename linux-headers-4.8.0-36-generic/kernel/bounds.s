...
# /build/linux-hwe-eyfT8D/linux-hwe-4.8.0/kernel/bounds.c -mno-sse -mno-mmx
...
1:	call	__fentry__
	...
	movq	%rsp, %rbp	#,
#APP
# 18 "/build/linux-hwe-eyfT8D/linux-hwe-4.8.0/kernel/bounds.c" 1
	
->NR_PAGEFLAGS $25 __NR_PAGEFLAGS	#
# 0 "" 2
# 19 "/build/linux-hwe-eyfT8D/linux-hwe-4.8.0/kernel/bounds.c" 1
	
->MAX_NR_ZONES $5 __MAX_NR_ZONES	#
# 0 "" 2
# 21 "/build/linux-hwe-eyfT8D/linux-hwe-4.8.0/kernel/bounds.c" 1
	
->NR_CPUS_BITS $9 ilog2(CONFIG_NR_CPUS)	#
# 0 "" 2
# 23 "/build/linux-hwe-eyfT8D/linux-hwe-4.8.0/kernel/bounds.c" 1
